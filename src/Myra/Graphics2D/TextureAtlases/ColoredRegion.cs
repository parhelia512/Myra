...
namespace Myra.Graphics2D.TextureAtlases
{
	...
	public class ColoredRegion : IImage
	{
		...
		/// <summary>
		/// Gets or sets the underlying texture region.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ColoredRegion"/> class.
		/// </summary>
		/// <param name="textureRegion">The texture region to wrap.</param>
		/// <param name="color">The color tint to apply.</param>
		/// <exception cref="ArgumentNullException">Thrown if textureRegion is null.</exception>
		...
		/// <summary>
		/// Draws the colored region to the render context.
		/// </summary>
